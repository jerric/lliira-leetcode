...
/**
 here is a ball in a maze with empty spaces and walls. The ball can go through empty spaces by
 ...
 hole by moving the shortest distance. The distance is defined by the number of empty spaces
 ...
 Both the ball and hole exist on an empty space, and they will not be at the same position
 initially.
 ...
 The maze contains at least 2 empty spaces, and the width and the height of the maze won't exceed
 30.
 */
public class P499Maze3 {
